...
const navigation = {
  productos: [
    ...
    { name: 'Productos Destacados', href: '/catalogo?featured=true' },
    { name: 'Galería', href: '/galeria' },
  ],
  empresa: [
    { name: 'Nosotros', href: '/nosotros' },
    { name: 'Proceso de Pedido', href: '/nosotros#proceso' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-light/80 mb-6 max-w-md">
              Pastelería artesanal especializada en tortas para eventos. Calidad
              premium, sabores únicos y diseños personalizados que harán de tu
            ...
            <div className="flex items-center gap-4">
              {socialLinks.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
                  className="p-2 bg-light/10 rounded-full hover:bg-primary transition-colors duration-200"
        ...
        <div className="pt-8 border-t border-light/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-light/60 text-sm">
              &copy; {new Date().getFullYear()} DeliDanis. Todos los derechos
              reservados.
            </p>
