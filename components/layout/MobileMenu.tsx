  ...
  return (
    <>
      ...
      <div
        ref={menuRef}
        className={cn(
          'fixed top-0 right-0 bottom-0 w-[300px] max-w-[85vw] bg-white z-50 shadow-2xl transition-transform duration-400 ease-out lg:hidden flex flex-col',
      ...
      >
        ...
        <nav ref={navRef} className="flex-1 px-5 py-4 overflow-y-auto">
        ...
        <div data-menu-cta className="px-5 py-4 border-t border-border/40 space-y-2.5 bg-white">
          <Link
            href="/agendar"
          ...
          <div className="flex gap-2.5">
            <Link
              href="/seguimiento"
              className="flex items-center justify-center gap-1.5 flex-1 py-2.5 px-4 border-2 border-dark/15 text-dark rounded-full font-medium text-sm hover:border-primary hover:text-primary transition-colors duration-200"
            >
            ...
            <a
              ...
              className="flex items-center justify-center gap-1.5 flex-1 py-2.5 px-4 border-2 border-[#25D366]/30 text-[#25D366] rounded-full font-medium text-sm hover:bg-[#25D366]/5 transition-colors duration-200"
            >
