    ...
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex min-h-full items-center justify-center p-4">
        ...
        <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-hidden">
          ...
          <button
            onClick={onClose}
            className="absolute top-3 right-3 z-20 p-2 bg-white/90 hover:bg-white rounded-full shadow-lg transition-colors"
            aria-label="Cerrar"
          >
          ...
          <div className="flex flex-col md:flex-row md:items-stretch md:max-h-[90vh]">
            ...
            <div className="relative bg-secondary md:w-[45%] md:flex-shrink-0">
              <div className="relative aspect-[4/5] md:aspect-auto md:h-full md:min-h-[480px]">
                ...
                {/* Bottom gradient + thumbnails */}
                {images.length > 1 && (
                  <>
                    <div className="absolute inset-x-0 bottom-0 h-24 bg-gradient-to-t from-black/40 to-transparent pointer-events-none z-[5]" />
                      ...
                      <div className="flex gap-1.5 justify-center">
                        {images.slice(0, 4).map((img, index) => (
                          <button
                            ...
                            className={`w-11 h-11 rounded-md overflow-hidden border-2 transition-all ${
            ...
            <div className="p-5 lg:p-6 md:flex-1 overflow-y-auto md:max-h-[90vh]">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <Link
                  href="/agendar"
                  className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-3 bg-primary text-white font-semibold rounded-full hover:bg-primary-hover transition-colors text-sm shadow-sm hover:shadow-md"
                >
                ...
                <a
                  ...
                  className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-3 bg-white border-2 border-dark/15 text-dark font-semibold rounded-full hover:border-primary hover:text-primary transition-colors text-sm"
                >
