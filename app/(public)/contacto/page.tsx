  ...
  return (
    <div className="min-h-screen bg-light-alt">
      ...
      <PageHeader
        ...
        title={
          <>
            <span className="italic font-accent text-primary">Conversemos</span>
          </>
        }
        description="Estamos aquí para hacer realidad la torta de tus sueños. Escríbenos y te responderemos a la brevedad."
        meta={
          <>
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-border bg-white px-4 py-2 text-sm font-medium text-dark shadow-sm hover:border-[#25D366]/40 hover:text-[#25D366] transition-colors"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-border bg-white px-4 py-2 text-sm font-medium text-dark shadow-sm hover:border-primary/40 hover:text-primary transition-colors"
            >
