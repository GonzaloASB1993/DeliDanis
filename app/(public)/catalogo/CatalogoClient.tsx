            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
              ...
              <div className="flex items-center gap-2 min-w-0 w-full sm:w-auto">
                <button
                  ...
                  className="lg:hidden flex items-center gap-1.5 px-3 py-2 border border-border rounded-lg bg-white text-dark text-sm hover:border-primary/50 transition-colors relative flex-shrink-0"
                >
