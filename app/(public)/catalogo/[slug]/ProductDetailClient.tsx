      ...
      <div className="bg-secondary py-4">
        <div className="container mx-auto px-4">
          <nav className="flex items-center gap-2 text-sm">
            <Link href="/" className="text-dark-light hover:text-primary">Inicio</Link>
            <span className="text-dark-light">/</span>
            <Link href="/catalogo" className="text-dark-light hover:text-primary">Catálogo</Link>
            <span className="text-dark-light">/</span>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="aspect-square bg-secondary rounded-2xl overflow-hidden relative">
              {currentImage ? (
                ...
                <div className="w-full h-full flex items-center justify-center">
                  <svg className="w-20 h-20 text-dark-light/30" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            <div className="flex flex-wrap gap-2 mb-4">
              <span className="px-3 py-1 bg-primary/10 text-primary rounded-full text-sm font-medium">Torta</span>
              {product.category && (
            ...
            <h1 className="font-display text-3xl md:text-4xl font-bold text-dark mb-4">{product.name}</h1>

            {product.description && (
              <p className="text-dark-light text-lg leading-relaxed mb-6">{product.description}</p>
            )}

            <div className="bg-secondary/50 rounded-xl p-5 mb-6">
              <label className="block font-semibold text-dark mb-3">Número de Porciones</label>
              ...
              <p className="text-sm text-dark-light mt-3 text-center">Rango: {minPortions} - {maxPortions} porciones</p>
            </div>
            ...
            <div className="bg-secondary rounded-xl p-5 mb-6">
              <div className="flex items-end justify-between mb-3">
                <div>
                  ...
                  <p className="font-display text-3xl md:text-4xl font-bold text-accent">{formatCurrency(calculatedPrice)}</p>
                </div>
              </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link href="/agendar" className="flex-1">
                <Button size="lg" className="w-full">Agendar Pedido</Button>
              </Link>
              <a
