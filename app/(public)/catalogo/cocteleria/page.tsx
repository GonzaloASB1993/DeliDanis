        ...
        eyebrow={{
          ...
          icon: (
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M3 5h18l-9 13L3 5z" />
            </svg>
          ),
        }}
        title={
          <>
            Coctelería <span className="text-primary italic font-accent">para eventos</span>
          </>
        }
        description="Delicias perfectas para tu evento, elaboradas artesanalmente para sorprender a tus invitados."
        meta={
          <>
            <PageHeaderChip>{products.length} productos</PageHeaderChip>
            <PageHeaderChip>{dulcesCount} dulces</PageHeaderChip>
            <PageHeaderChip>{saladosCount} salados</PageHeaderChip>
          </>
        }
      />
                          ...
                          <div className="absolute inset-0 flex items-center justify-center">
                            <div className="text-center transform group-hover:scale-110 transition-transform duration-500">
                              <svg className="w-14 h-14 text-dark-light/30" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d={category === 'dulce' ? 'M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z' : 'M3 5h18l-9 13L3 5z M12 18v3 M8 21h8'} />
                              </svg>
                            </div>
                          </div>
                        )}
